...
Node* mulLists2(Node* _head1, Node* _head2);

Node* mulLists2Imp(Node* _head1, Node* _head2, Node* _head3);
...
/*--------------------------------------------------------------------*/
/*create list 3 on the recursion */

Node* mulLists2(Node* _head1, Node* _head2)
{
	Node* head3 = malloc(sizeof(Node));

	mulLists2Imp(_head1, _head2, head3);
...
Node* mulLists2Imp(Node* _head1, Node* _head2, Node* _head3)
{
	...
	_head3->m_next = malloc(sizeof(Node));
	
	_head1 = mulLists2Imp(_head1, _head2->m_next, _head3->m_next);
