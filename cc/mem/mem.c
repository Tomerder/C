...
int main(int argc,char** argv)
{
	...
	char charInit = 'a';
	char charNotInit;
	char* charPtrConst1	= "XXX";
	char* charPtrConst2 = "test charPtrConst";
	char* charPtrNotInit;
	char charArrInit[] = "test charPtrArr[]";
	char charArrSizeInit[SIZE_OF_STACK_ALOC] = "test charPtrArr[50]";
	/*static locals*/
	static char* locStatCharPtrConst1 = "123";
	static char* locStatCharPtrConst2 = "test locStatCharPtrInit";
	char* charPtrConst3 = "ABC";
	...
	*charPtrDynamic1 = 1;
	...
	printf("---------------------------------------------------\n");	
	printf("NULL and consts - virtual page #0 :\n");
	...
	printf("---------------------------------------------------\n");	
	printf("txt segment - TXT:   RO !!!\n");
	printf("other objects funcs -> main -> funcs -> poiners that were initialized with constants (char* charPtrConst = ''XXX'')\n");
	...
	PRINT_ADR_PTR(charPtrConst1);
	PRINT_ADR_PTR(charPtrConst2);
	PRINT_ADR_PTR(locStatCharPtrConst1);
	PRINT_ADR_PTR(locStatCharPtrConst2);
	PRINT_ADR_PTR(charPtrConst3);
